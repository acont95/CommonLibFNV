...
namespace CommonLib {
  ...
  enum WEAPON_TYPE
  {
    ...
    WEAPON_HAND_TO_HAND = 0x0,
    WEAPON_ONE_HAND_MELEE = 0x1,
    WEAPON_TWO_HAND_MELEE = 0x2,
    WEAPON_ONE_HAND_PISTOL = 0x3,
    WEAPON_ONE_HAND_PISTOL_ENERGY = 0x4,
    WEAPON_TWO_HAND_RIFLE = 0x5,
    WEAPON_TWO_HAND_AUTOMATIC = 0x6,
    WEAPON_TWO_HAND_RIFLE_ENERGY = 0x7,
    WEAPON_TWO_HAND_HANDLE = 0x8,
    WEAPON_TWO_HAND_LAUNCHER = 0x9,
    WEAPON_ONE_HAND_GRENADE = 0xA,
    WEAPON_ONE_HAND_MINE = 0xB,
    WEAPON_ONE_HAND_LUNCHBOX_MINE = 0xC,
    WEAPON_ONE_HAND_THROWN = 0xD,
    WEAPON_TYPE_COUNT = 0xE,
  };
